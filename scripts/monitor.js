...
function runAIPredictiveMonitoring() {
  ...
  console.log(`📊 Predicted (next 5min): CPU=${prediction.cpu.toFixed(2)}% | Memory=${prediction.memory.toFixed(2)}% | Traffic=${prediction.traffic.toFixed(0)} req/s | Confidence=${prediction.confidence}%`);
